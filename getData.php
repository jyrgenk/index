...
echo 'remove die!'; //remove die from import
die;

$html = '<option value="1">Manufacturing</option>
...
for ($i = 0; $i < count($nodes); $i++) {
  $value = $i;
  $name = $dom->getElementsByTagName('option')->item($i)->nodeValue;
  $db->query("INSERT INTO sectors (sectorValue, sectorName) VALUES ($value, '$name')");
}
